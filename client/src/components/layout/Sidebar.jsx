...
const HomeSolid = ({ className = 'w-5 h-5' }) => (
...
const ListSolid = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
const navItems = [
  ...
  { to: '/tasks', label: 'Tasks', icon: ListIcon, iconActive: ListSolid },
  { to: '/tasks/new', label: 'New Task', icon: PlusIcon },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 hidden md:flex flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
